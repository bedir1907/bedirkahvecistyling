                      ...
                      <tr id={`product-${product.id}`} className="border-b last:border-b-0 align-middle">
                        ...
                        <td className="p-4">
                          <div className="flex flex-wrap gap-2">
                            <button type="button" onClick={() => { if (isEditing) { cancelEdit(); router.push("/admin/products") } else { router.push(`/admin/products?edit=${product.id}`) } }}
                        ...
                        <tr className="bg-gray-50 border-b">
                          <td colSpan={10} className="p-6">
                            ...
                            <div className="flex gap-3 mt-6">
                              ...
                              <button type="button" onClick={() => { cancelEdit(); router.push("/admin/products") }} className="border px-5 py-3 rounded-xl">İptal</button>
                            </div>
                          </td>
                        </tr>
                      )}
