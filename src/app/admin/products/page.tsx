                    ...
                    <div className="mt-8">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            Bu ürüne ait bedenleri ve stoklarını gir.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mb-4 flex flex-wrap gap-2">
                        {newSizeType !== "custom" ? (
                          getAvailableSizes(newSizeType).map((size) => {
                            ...
                            return (
                              <button
                                key={size}
                                type="button"
                                onClick={() => addVariantToDraft(size)}
                          ...
                          <button
                            type="button"
                            onClick={addCustomVariantToDraft}
                      ...
                      {newVariants.length === 0 ? (
                        <div className="border rounded-2xl bg-white p-5 text-sm text-gray-500">
                                ...
                                <tr key={variant.id} className="border-t">
                                  ...
                                  <td className="p-4 text-[15px]">
                                    <button
                                      ...
                                      className="border border-red-500 text-red-500 px-3 py-2 rounded-lg hover:bg-red-500 hover:text-white"
                                    >
                                      Sil
                                    </button>
                                  </td>
                        ...
                        <td className="p-4">
                          <div className="flex flex-wrap gap-2">
                            ...
                            <button
                              type="button"
                              onClick={() => {
                                window.location.href = `/admin/products/${product.id}/images`
                              }}
                              className="border border-black px-3 py-2 rounded-xl hover:bg-black hover:text-white"
                            >
                              Görseller
                        ...
                        <tr className="bg-gray-50 border-b">
                          <td colSpan={10} className="p-6">
                            <div className="mb-5">
                              ...
                              <p className="text-sm text-gray-500 mt-1">
                                {product.name} ürününe ait detayları buradan güncelleyebilirsin.
                              </p>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4">
                              ...
                              <select
                                value={editSizeType}
                                onChange={(e) => {
                                  setEditSizeType(e.target.value as "letter" | "number" | "custom")
                                  setEditVariants([])
                                }}
                                className="border rounded-xl px-4 py-3"
                              >
                              ...
                              <div className="md:col-span-2 xl:col-span-4 flex flex-wrap gap-3">
                                <CloudinaryUploadButton
                                  buttonText="Yeni Kapak Görseli Yükle"
                                  onUploadSuccess={(url) =>
                            ...
                            <div className="mt-8">
                              <div className="flex items-center justify-between mb-4 gap-4">
                                <div>
                                  ...
                                  <p className="text-sm text-gray-500">
                                    Bu ürüne ait bedenleri ve stokları ayrı yönetebilirsin.
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="mb-4 flex flex-wrap gap-2">
                                {editSizeType !== "custom" ? (
                                  getAvailableSizes(editSizeType).map((size) => {
                                    ...
                                    return (
                                      <button
                                        key={size}
                                        type="button"
                                        onClick={() => addVariantToExisting(size)}
                                        className={`px-3 py-2 rounded-xl border text-[15px] ${
                                          exists
                                            ? "bg-black text-white border-black"
                                            : "border-gray-300 hover:border-black"
                                        }`}
                                  ...
                                  <button
                                    type="button"
                                    onClick={addCustomVariantToExisting}
                                    className="border border-black px-4 py-2 rounded-xl hover:bg-black hover:text-white text-[15px]"
                                  >
                                    Özel Beden Ekle
                                  </button>
                                )}
                                              ...
                                              <button
                                                ...
                                                onClick={() =>
                                                  updateExistingVariantField(
                                                    variant.id,
                                                    "stock",
                                                    Math.max(0, Number(variant.stock) - 1)
                                                  )
                                                }
                                                className="w-8 h-8 border rounded-lg"
                                              >
                            ...
                            {siblingProducts.length > 0 && (
                              <div className="mt-8">
                                <div className="mb-3">
                                  ...
                                  <p className="text-sm text-gray-500">
                                    Ürün detayında “diğer renkler” alanında bunlar gösterilecek.
                                  </p>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-3">
                                  {siblingProducts.map((item) => (
                                    <div
                                      key={item.id}
                                      className="flex items-center gap-3 border rounded-xl bg-white px-3 py-2"
                                    >
