...
export default async function AdminDashboardPage() {
  ...
  const cards = [
    { title: "Aktif Ürün", value: activeProductCount, sub: `${productCount} toplam`, href: "/admin/products", color: "bg-blue-50 text-blue-600" },
    { title: "Tükenen Varyant", value: outOfStockCount, sub: "stok 0", href: "/admin/stock", color: "bg-red-50 text-red-600" },
    { title: "Toplam Sipariş", value: totalOrders, sub: `${paidOrders} ödendi`, href: "/admin/orders", color: "bg-green-50 text-green-600" },
    { title: "Kategori", value: categoryCount, sub: "aktif kategori", href: "/admin/categories", color: "bg-purple-50 text-purple-600" },
  ]
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-2xl border p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/orders" className="text-xs text-gray-500 hover:text-black transition">Tümü →</Link>
          </div>
        ...
        <div className="bg-white rounded-2xl border p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/stock" className="text-xs text-gray-500 hover:text-black transition">Stok →</Link>
          </div>
